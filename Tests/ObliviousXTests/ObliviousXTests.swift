...
final class ObliviousXTests: XCTestCase {
    ...
    func testObliviousStringRoundTrip_XWing() throws {
        ...
        let serverKey = try XWingMLKEM768X25519.PrivateKey()
        ...
        XCTAssertEqual(parsed.keyID, 66)
        XCTAssertEqual(parsed.kem, .XWingMLKEM768X25519)
        XCTAssertEqual(parsed.kdf, .HKDF_SHA256)
        XCTAssertEqual(parsed.aead, .AES_GCM_256)
    ...
    func testSimpleStreamingHappyPath_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
    ...
    func testStreamingIsOrderDependent_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
    ...
    func testStreamingRequestIsOrderDependent_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
    ...
    func testAgreeingOnFinalityWorks_request_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
    ...
    func testAgreeingOnFinalityWorks_response_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
    ...
    func testDisagreeingOnFinalityIsAnError_request_recipientMissing_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
    ...
    func testDisagreeingOnFinalityIsAnError_request_senderMissing_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
    ...
    func testDisagreeingOnFinalityIsAnError_response_recipientMissing_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
    ...
    func testDisagreeingOnFinalityIsAnError_response_senderMissing_XWing() throws {
        guard #available(iOS 26.0, macOS 26.0, watchOS 26.0, tvOS 26.0, visionOS 26.0, *) else {
            throw XCTSkip("XWing not available")
        }
