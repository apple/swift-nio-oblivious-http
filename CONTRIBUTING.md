...
* Commit hash
* Contextual information (e.g. what you were trying to achieve with swift-nio-oblivious-http)
...
Context:
While testing my application that uses with swift-nio-oblivious-http I noticed that ...
...
Please open a pull request at https://github.com/apple/swift-nio-oblivious-http. Make sure the CI passes, and then wait for code review.
